...
export function AboutText(){
  return(
    Container(
      ...
      p(`
        During my college education, I took two software development classes that used C++ and Python. In the fall of 2019
        ...
        management identify areas where costs could be reduced and where processes needed to be improved.
      `),
      p(`
      ...
      `),
      p(`
        Then, Covid-19 hit and I had to be put on furlough due to work coming in from dentists decreasing by almost 80%.
      ...
      `),
      p(`
        After returning to work I used my newfound knowledge to make reports, dashboards, and tools that would be able to outlast
        my time at Avadi and that would update realtime with the database. I learned and began using Node.js and Express to finally
        deploy these tools as an application on their server.
      `),
      p(`
